...
/**
 * Class DestinyExplorerTalentNodeStepsService
 * @package Necowebs\Destiny\Services\Explorer
 */
class DestinyExplorerTalentNodeStepsService extends BaseService
{
    /**
     ...
     */
    public function getDestinyExplorerTalentNodeSteps(array $parameters = [])
    {
